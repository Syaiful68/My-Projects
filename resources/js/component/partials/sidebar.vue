        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebar-menu">
                <ul class="navbar-nav pt-lg-3">
                    <li class="nav-item" v-if="user.rules === 'admin'">
                    ...
                    <li class="nav-item" v-if="user.rules === 'user'" :class="{ 'active': $page.url === '/fuel' }">
                        <Link class="nav-link" :class="{ 'active': $page.url === '/fuel' }" href="/fuel">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="nav-item " :class="{ 'active': $page.url === '/armada' }">
                        <Link class="nav-link" :class="{ 'active': $page.url === '/armada' }" href="/armada">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="nav-item dropdown" :class="{ 'active': $page.url.startsWith('/settings') }">
                        ...
                        <div class="dropdown-menu" :class="{ 'show': $page.url.startsWith('/settings') }">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <Link v-if="user.rules === 'admin'" class="dropdown-item"
                                        :class="{ 'active': $page.url === '/settings/user' }" href="/settings/user">
                                    User
                                    </Link>
                                    <Link class="dropdown-item" :class="{ 'active': $page.url === '/settings/report' }"
                ...
                <div class="d-flex justify-content-end">
                    <ul class="navbar-nav">
                        <li class="li nav-item">
                            <button type="button" @click="signOut" class="nav-link">
                                <span
                                    class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
